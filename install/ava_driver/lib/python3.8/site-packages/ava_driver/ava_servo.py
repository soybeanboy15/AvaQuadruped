...
class Servos():
    ...
    def CalibrateServo(self):
        ...
        self.kit.servo[1].set_pulse_width_range(min_pulse=960, max_pulse = 2320) # FL Knee (-)
        self.kit.servo[2].set_pulse_width_range(min_pulse=800, max_pulse = 2160) # FL Hip (+)

        self.kit.servo[3].set_pulse_width_range(min_pulse=860, max_pulse = 2140) # BL Leg (+)
        ...
        self.kit.servo[6].set_pulse_width_range(min_pulse=860, max_pulse = 2160) # BR Leg (-)
        self.kit.servo[7].set_pulse_width_range(min_pulse=760, max_pulse = 2040) # BR Knee (+)
        self.kit.servo[8].set_pulse_width_range(min_pulse=620, max_pulse = 1900) # BR Hip (+)

        self.kit.servo[9].set_pulse_width_range(min_pulse=920, max_pulse = 2160) # FR Leg (-)
        self.kit.servo[10].set_pulse_width_range(min_pulse=500, max_pulse = 2460) # FR Knee (+)
