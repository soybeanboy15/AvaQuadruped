...
bool ava_msgs__msg__ava_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ava_msgs.msg._ava_command.AvaCommand", full_classname_dest, 36) == 0);
  }
  ava_msgs__msg__AvaCommand * ros_message = _ros_message;
  {  // state_msg
...
{
  /* NOTE(esteve): Call constructor of AvaCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ava_msgs.msg._ava_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AvaCommand");
