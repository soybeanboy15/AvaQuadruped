...
bool ava_msgs__msg__ava_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ava_msgs.msg._ava_info.AvaInfo", full_classname_dest, 30) == 0);
  }
  ava_msgs__msg__AvaInfo * ros_message = _ros_message;
  {  // state
...
{
  /* NOTE(esteve): Call constructor of AvaInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ava_msgs.msg._ava_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AvaInfo");
