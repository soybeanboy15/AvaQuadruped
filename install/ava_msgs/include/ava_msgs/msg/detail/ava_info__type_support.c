...
#include <stddef.h>
#include "ava_msgs/msg/detail/ava_info__rosidl_typesupport_introspection_c.h"
...
void AvaInfo__rosidl_typesupport_introspection_c__AvaInfo_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  ava_msgs__msg__AvaInfo__init(message_memory);
}

void AvaInfo__rosidl_typesupport_introspection_c__AvaInfo_fini_function(void * message_memory)
{
...
static rosidl_typesupport_introspection_c__MessageMember AvaInfo__rosidl_typesupport_introspection_c__AvaInfo_message_member_array[3] = {
  {
    ...
    offsetof(ava_msgs__msg__AvaInfo, state),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ava_msgs__msg__AvaInfo, velocity),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers AvaInfo__rosidl_typesupport_introspection_c__AvaInfo_message_members = {
  ...
  AvaInfo__rosidl_typesupport_introspection_c__AvaInfo_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t AvaInfo__rosidl_typesupport_introspection_c__AvaInfo_message_type_support_handle = {
  0,
  &AvaInfo__rosidl_typesupport_introspection_c__AvaInfo_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ava_msgs, msg, AvaInfo)() {
  ...
  return &AvaInfo__rosidl_typesupport_introspection_c__AvaInfo_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
