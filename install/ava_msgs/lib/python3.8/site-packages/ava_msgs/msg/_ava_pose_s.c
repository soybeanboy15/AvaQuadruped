...
bool ava_msgs__msg__ava_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ava_msgs.msg._ava_pose.AvaPose", full_classname_dest, 30) == 0);
  }
  ava_msgs__msg__AvaPose * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of AvaPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ava_msgs.msg._ava_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AvaPose");
