...
#include "ava_msgs/msg/detail/ava_pose__rosidl_typesupport_fastrtps_c.h"
...
using _AvaPose__ros_msg_type = ava_msgs__msg__AvaPose;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AvaPose__ros_msg_type * ros_message = static_cast<const _AvaPose__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    cdr << ros_message->x;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _AvaPose__ros_msg_type * ros_message = static_cast<_AvaPose__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    cdr >> ros_message->x;
  }
...
static uint32_t _AvaPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ava_msgs__msg__AvaPose(
...
{
  return max_serialized_size_ava_msgs__msg__AvaPose(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_AvaPose = {
  "ava_msgs::msg",
  "AvaPose",
...
static rosidl_message_type_support_t _AvaPose__type_support = {
