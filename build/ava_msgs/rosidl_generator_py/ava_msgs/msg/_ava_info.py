...
class Metaclass_AvaInfo(type):
    """Metaclass of message 'AvaInfo'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ava_msgs.msg.AvaInfo')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__ava_info
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__ava_info
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__ava_info
...
class AvaInfo(metaclass=Metaclass_AvaInfo):
    """Message class 'AvaInfo'."""
