...
#include "ava_msgs/msg/detail/leg_position__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: fl_leg_pos
  {
    cdr << ros_message.fl_leg_pos;
  }
  // Member: fr_leg_pos
  {
    cdr << ros_message.fr_leg_pos;
  }
  // Member: br_leg_pos
  {
    cdr << ros_message.br_leg_pos;
  }
  // Member: bl_leg_pos
  {
    cdr << ros_message.bl_leg_pos;
  }
  return true;
}
  ...
  size_t current_alignment)
{
  ...
  // Member: fl_leg_pos
  {
    ...
    size_t item_size = sizeof(ros_message.fl_leg_pos[0]);
  ...
  // Member: fr_leg_pos
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.fr_leg_pos[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: br_leg_pos
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.br_leg_pos[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: bl_leg_pos
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.bl_leg_pos[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
{
  auto typed_message =
    static_cast<const ava_msgs::msg::LegPosition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ava_msgs::msg::LegPosition *>(
    untyped_ros_message);
...
{
  return max_serialized_size_LegPosition(full_bounded, 0);
}
...
{
  return &ava_msgs::msg::typesupport_fastrtps_cpp::_LegPosition__handle;
}
