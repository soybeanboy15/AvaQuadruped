...
static rosidl_typesupport_introspection_c__MessageMember AvaCommand__rosidl_typesupport_introspection_c__AvaCommand_message_member_array[3] = {
  {
    "state_msg",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ava_msgs__msg__AvaCommand, teleop),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ava_msgs__msg__AvaCommand, keyhit),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
