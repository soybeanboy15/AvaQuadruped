...
set "AMENT_ENVIRONMENT_HOOKS[slam_toolbox]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[slam_toolbox] "%AMENT_CURRENT_PREFIX%\share\slam_toolbox\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[slam_toolbox] "%AMENT_CURRENT_PREFIX%\share\slam_toolbox\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[slam_toolbox] "%AMENT_CURRENT_PREFIX%\share\slam_toolbox\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[slam_toolbox]:;=";"%") do (
    call:call_file %%f
  )
